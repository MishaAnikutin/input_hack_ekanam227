...
from service.schemas import UserTickersResponse, AddTickerToUserRequest, UserTickerBase, RemoveTickerFromUserRequest
...
async def remove_ticker_from_user(
    ...
    try:
        return await service.remove_ticker_from_user(telegram_id=telegram_id, ticker=ticker)
    except ValueError as e:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail=str(e))
